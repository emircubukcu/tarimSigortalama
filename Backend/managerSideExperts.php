      ...
      <div class="row">
        <div class="col-md-8 mx-auto">
          <div class="text-center">
            <h1 class="text-white">Eksperler</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card">
          <div class="table-responsive">
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Eksper Adı</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Eksper Soyadı</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Eksper Durumu</th>
                  <th></th>
                </tr>
              </thead>
...
<?php
	...
	while($gelen=mysqli_fetch_array($cevap))
	{
     ...
     echo                   "<h6 class='mb-0 text-xs'>".$gelen['eksper_ad']."</h6>";
     echo                 "</div>";
     echo              " </div>";
     echo             "</td>";
     echo             "<td>";
     echo               "<p class='text-xs font-weight-normal mb-0'>".$gelen['eksper_soyad']."</p>";
     echo             "</td>";
     echo             "<td>";
     echo               "<span class='badge badge-dot me-4'>";
     echo                 "<i class='bg-info'></i>";
     echo                 "<span class='text-dark text-xs'>".$gelen['eksper_durum']."</span>";
     echo               "</span>";
     echo             "</td>";

...
<body>
      ...
      <div class="row">
        <div class="col-md-8 mx-auto">
          <div class="text-center">
            <h1 class="text-white">Görevler</h1>
          </div>
        </div>
      </div>
    </div>
 ...
 <?php			  
	...
	$eid=$gelen2["eksper_id"];
	
	$sql = "SELECT tarla_ad,tarla_boyut,tarla_konum,tarla_urun FROM tarla WHERE eksper_id='$eid'";
	...
	echo				"<a href='expertSideReport.php'>";

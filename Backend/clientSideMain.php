...
$sql="SELECT musteri_ad,musteri_soyad FROM musteri WHERE musteri_email='$kuladi'";
      ...
      <div class="row">
        <div class="col-md-8 mx-auto">
          <div class="text-center">
            ...
            <h3 class="text-white"><?php echo $gelen['musteri_ad']; echo ' '; echo $gelen['musteri_soyad'] ?></h3>
          </div>
        </div>
      </div>
    </div>
